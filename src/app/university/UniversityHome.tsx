  ...
  return (
      <div className='bg-[#012060] flex md:flex-row flex-col md:h-[500px]'>
          <div className="section-1 text-section p-6 md:w-1/2 flex flex-col justify-center md:text-start text-center">
            <span className='text-[15px]  text-center font-[700] bg-white text-[#06182F] rounded-md w-[200px]'>About [University Name]</span>
            <h1 className='text-[50px] font-[700] text-white '>Empowering Minds, Transforming Futures.</h1>
          </div>
      ...
      <Image
        width={500}
        height={800}
        src="/img/university/UniversityHome/Rectangle 26 (2).png"
