            ...
            <div className="flex items-center">
              <Link href="/" aria-label="Return to homepage" className="transition-transform duration-300 hover:scale-105">
                <div itemScope itemType="https://schema.org/Organization" className="flex items-center gap-3">
                  ...
                  />
                  <span className="hidden sm:block text-white font-bold text-xl tracking-tight bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">Institution<span className="text-orange-500">Name</span></span>
                </div>
              </Link>
            </div>
